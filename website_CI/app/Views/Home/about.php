...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>/css/about-stylesheet.css" type="text/css">
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide col-lg-5 col-xs-8" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-intervall="8">
                                        <img src="<?php echo base_url(); ?>/img/Teammitglied1.jpg" class="d-block w-100 img-fluid" alt="lukas">
                                    ...
                                    <div class="carousel-item" data-intervall="8">
                                        <img src="<?php echo base_url(); ?>/img/Teammitglied1.jpg" class="d-block w-100 img-fluid" alt="lam">
                                        <div class="carousel-caption  d-xs-block">
                                            <h5>Lam</h5>
                                            <p>Author :)</p>
                                        </div>
                                    ...
                                    <div class="carousel-item h-100" data-intervall="false" data-pause="hover">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <video class="w-100 embed-responsive-item"  width="1280" height="720" controls><source src="<?php echo base_url(); ?>/img/SampleVideo_1280x720_1mb (2).mp4" type="video/mp4"></video>
                                        </div>
                                    </div>
                                </div>
