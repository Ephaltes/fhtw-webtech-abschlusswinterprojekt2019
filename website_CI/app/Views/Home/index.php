...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() . "/" ?>css/index-stylesheet.css" type="text/css">
    ...
    <body style="padding-top:60px;">
        <header>
            ...
            <nav class="navbar navbar-dark navbar-expand-md bg-dark fixed-top">
                <img src="<?php echo base_url() . "/" ?>img/342_logo_big_FH_only.png" class="pl-5 img-fluid " style="height:50px;">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav d-flex flex-wrap align-content-end ml-auto">
                        ...
                        if (!empty($user)) {
                            ?>
                            <li class="nav-item active"><a class="nav-link text-success" href="<?php echo base_url() . "/home/logout" ?> ">Abmelden</a></li>
<?php } ?>
            ...
            <div class="">
                <div id="quicklinks" class="bg-dark pt-1 pb-1 "> <!-- center this !!!edit-->
                    <ul class="d-flex align-content-start flex-wrap flex-xs-row pt-2">
                        ...
                        <li class="col-1"><a class=" text-success" href="">randomNews1</a></li>
                        <li class="col-1"><a class=" text-success" href="https://cis.technikum-wien.at/cis/index.php">CIS</a>
                        </li>
                        ...
                        <div class="card border-success">
                            ...
                            <div class="card mb-3 border-success border-left-0 border-right-0">
                                <div class="row no-gutters ">
                                    <div class="col-md-4">
                                        <img src="<?php echo base_url() . "/" ?>img/teammitglied1.jpg" class="card-img p-2 d-block mx-auto"
                                             alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <a class="card-title tect-success" href="<?php echo base_url()?>/home/dynamicnews"><h5>News1</h5></a>
                            ...
                            <div class="card mb-3 border-success  border-left-0 border-right-0">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <a class="card-title tect-success" href="<?php echo base_url()?>/home/dynamicnews"><h5>News2</h5></a>
                                            <p class="card-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                                diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed
                                                diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet
                                                clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
                            ...
                            <div class="card border-success  border-left-0 border-right-0">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <a class="card-title tect-success" href="<?php echo base_url()?>/home/dynamicnews"><h5>News3</h5></a>
                                            <p class="card-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                                diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed
                                                diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet
                                                clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 pt-2" id="hallo1">
                        ...
                        <ul class="d-flex align-content-start flex-wrap flex-xs-row flex-md-column pl-0">
                            <li class="pl-3 pr-3 "><a class="text-white" href="https://www.facebook.com" target="_blank">Facebook</a>
                            </li>
                            <li class="pl-3 pr-3"><a class="text-white" href="https://www.twitter.com"
                    ...
                    <div class="border-dotted-left col-xs-12 col-sm-6 col-md-3 pt-2" id="hallo2">
                        ...
                        <ul class="d-flex align-content-start flex-wrap flex-xs-row flex-md-column pl-0">
                            <li class="pl-3 pr-3"><a class="text-white" href="http://www.technikumwien.at" target="_blank">Webpage</a>
                            </li>
                        </ul>
                    </div>
                    <div class="border-dotted-left col-xs-12 col-sm-6 col-md-3 pt-2" id="hallo3">
                        ...
                        <ul class="d-flex align-content-start flex-wrap flex-xs-row flex-md-column pl-0">
                            <li class="pl-3 pr-3"><a class="text-white" href="">Copyright</a></li>
                            <!-- Placeholder for Future use -->
                            <li class="pl-3 pr-3"><a class="text-white" href="">Privacy Policy</a></li>
                            <!-- Placeholder for Future use-->
                        </ul>
                    </div>
