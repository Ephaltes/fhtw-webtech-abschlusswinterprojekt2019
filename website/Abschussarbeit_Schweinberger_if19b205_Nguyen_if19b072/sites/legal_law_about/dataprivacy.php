...
<section id ="Datenschutz">
    <div class="container py-2">
        ...
        <ul class = "">
            <li class = "">die Adresse (URL) der aufgerufenen Webseite</li>
            <li class = "">Browser und Browserversion</li>
            <li class = "">das verwendete Betriebssystem</li>
            <li class = "">die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</li>
            <li class = "">den Hostname und die IP-Adresse des Geräts von welchem aus zugegriffen wird</li>
            <li class = "">Datum und Uhrzeit</li>
        </ul>
        ...
        <h2 class = "">Speicherung persönlicher Daten</h2>
        ...
        <p>
            <strong class = "">Name:</strong> _ga<br />
            <strong class = "">Wert:</strong> GA1.2.1326744211.152221108837
            <strong class = "">Verwendungszweck:</strong> Unterscheidung der Webseitenbesucher<br />
            <strong class = "">Ablaufdatum:</strong> nach 2 Jahren</p>
        <p>Diese Mindestgrößen sollte ein Browser unterstützen können:</p>
        <ul class = "">
            <li class = "">Mindestens 4096 Bytes pro Cookie</li>
            <li class = "">Mindestens 50 Cookies pro Domain</li>
            <li class = "">Mindestens 3000 Cookies insgesamt</li>
        </ul>
        <h3 class = "">Welche Arten von Cookies gibt es?</h3>
        <p>Die Frage welche Cookies wir im Speziellen verwenden, hängt von den verwendeten Diensten ab und wird in den folgenden Abschnitten der Datenschutzerklärung geklärt. An dieser Stelle möchten wir kurz auf die verschiedenen Arten von HTTP-Cookies eingehen.</p>
        <p>Man kann 4 Arten von Cookies unterscheiden:</p>
        <p>
            <strong class = "">Unerlässliche Cookies<br />
        ...
        <p>
            <strong class = "">Zweckmäßige Cookies<br />
        ...
        <p>
            <strong class = "">Zielorientierte Cookies<br />
            </strong>Diese Cookies sorgen für eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten gespeichert.</p>
        <p>
            <strong class = "">Werbe-Cookies<br />
            </strong>Diese Cookies werden auch Targeting-Cookies genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber auch sehr nervig sein.</p>
        <p>Üblicherweise werden Sie beim erstmaligen Besuch einer Webseite gefragt, welche dieser Cookiearten Sie zulassen möchten. Und natürlich wird diese Entscheidung auch in einem Cookie gespeichert.</p>
        <h3 class = "">Wie kann ich Cookies löschen?</h3>
