    ...
    <div class="container">
        <div class="row">
            ...
            <div class="border-dotted-left col-xs-12 col-sm-6 col-md-3 pt-2" id="hallo3">
                ...
                <ul class="d-flex align-content-start flex-wrap flex-xs-row flex-md-column pl-0">
                    <li class="pl-3 pr-3"><a class="text-white" href="index.php?viewme=AGB" target="_blank">AGB</a></li>
                    <li class="pl-3 pr-3"><a class="text-white" href="index.php?viewme=Datenschutz" target="_blank">Datenschutz</a></li>
                </ul>
            </div>
