...
<section id="quicklinks" class="mt-2">
    <div id="quicklinksdiv" class="bg-dark pb-1 " role="group"> <!-- center this !!!edit-->
        <div class="row py-3 mx-0 justify-content-center">
            <div class="col-12 text-center mb-2 p-2 col-lg-auto"><a id="random_news_a" class="text-light" href="#" role="link" tabindex="90">zufällige News</a></div>
            <!-- <li class="p-3"><a class=" text-light" href="">randomNews1</a></li> -->
            <div class="col-12 text-center mb-2 p-2 col-lg-auto "><a class=" text-light" target="_self" role="link" href="index.php?viewme=Anleitung" tabindex="91">Bedienungsanleitung</a></div>
            <div class="col-12 text-center mb-2 p-2 col-lg-auto"><a class=" text-light" target="_blank" role="link" rel="noreferrer" href="https://cis.technikum-wien.at/cis/index.php" tabindex="92">CIS</a></div>
