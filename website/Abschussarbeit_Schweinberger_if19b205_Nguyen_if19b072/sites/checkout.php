                                ...
                                foreach ($_SESSION['cart'] as $key) {
                                    ...
                                    foreach ($read as $data) {
                                        if ($data->id == $item) {
                                            ...
                                            echo "<td scope=\"row\" class=\"ml-2\"><div class=\"\"><img src=\"data/shop/bilder/$data->bild\" class=\"d-block pull-left mr-2 float-left img-fluid\" style=\"width:75px;\"><div class=\"\"><div><h4 class=\"\">$data->titel</h4><small><i>$data->beschreibung</i></small></div></td>";
            ...
            <div class="row py-5 p-4 bg-white rounded ">
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        <textarea name="userfeedback" cols="30" rows="2" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-lg-6">
